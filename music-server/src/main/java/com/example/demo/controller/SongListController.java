...
public class SongListController {
    ...
    public Object updateSongListPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) {
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "music" + System.getProperty("file.separator") + "songListPic";
        ...
        String storeAvatorPath = "/music/songListPic/" + fileName;
        try {
