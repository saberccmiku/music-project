...
public class SingerController {
    ...
    public Object updateSingerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) {
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "music" + System.getProperty("file.separator") + "singerPic";
        ...
        String storeAvatorPath = "/music/singerPic/" + fileName;
        try {
